def getGMatByMask(w, h, mask):
    ...
    valsGx= np.zeros(imgSize*2,1)
    indsGy1 = np.zeros(imgSize*2,1)
    indsGy2 = np.zeros(imgSize*2,1)
    valsGy = np.zeros(imgSize*2,1)
    indsG31 = np.zeros(imgSize*2,1)
    indsG32 = np.zeros(imgSize*2,1)
    valsG3 = np.zeros(imgSize*2,1)
    indsG41 = np.zeros(imgSize*2,1)
